...
func SetCookie(value []byte, name string, seckretKey []byte) *http.Cookie {
	...
	fmt.Println("26 signature: ", signature)
	fmt.Println("27value: ", value)
	fmt.Println("28 seckretKey: ", seckretKey)
	fmt.Println("29 bytes of name: ", []byte(name))
	fmt.Printf("30 len of string value: %v\n", len(value))
