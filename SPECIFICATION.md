...
- `409` — логин уже занят;//StatusConflict
...
- `400` — неверный формат запроса;
- `401` — неверная пара логин/пароль;//StatusUnauthorized
- `500` — внутренняя ошибка сервера.
...
- `202` — новый номер заказа принят в обработку;StatusAccepted
- `400` — неверный формат запроса;
- `401` — пользователь не аутентифицирован;
- `409` — номер заказа уже был загружен другим пользователем;StatusConflict
